...
public class PersistenciaProductos {
    ...
    public static void guardarCsv(List<ProductoKiosco> lista, String archivo) {
    ...
    public static void cargarCsv(List<ProductoKiosco> lista, String archivo) {
        try (BufferedReader br = new BufferedReader(new FileReader(archivo))) {
            ...
            while (linea != null) {
                ...
                if (partes.length >= 6) {
                    ...
                    lista.add(new Snack(id, nombre, marca, precio, stock));
                }
    ...
    public static void guardarJson(List<ProductoKiosco> lista, String archivo) {
        try (PrintWriter pw = new PrintWriter(new FileWriter(archivo))) {
    ...
    public static void cargarJson(List<ProductoKiosco> lista, String archivo) {
        try (BufferedReader br = new BufferedReader(new FileReader(archivo))) {
